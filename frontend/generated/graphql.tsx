...
export type LoginMutation = (
  ...
  & { login: (
    { __typename?: 'UserResponse' }
    & Pick<UserResponse, 'message' | 'accessToken'>
    & { user?: Maybe<(
      { __typename?: 'User' }
...
export function useProtectedQuery(baseOptions?: Apollo.QueryHookOptions<ProtectedQuery, ProtectedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProtectedQuery, ProtectedQueryVariables>(ProtectedDocument, options);
      }
export function useProtectedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProtectedQuery, ProtectedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProtectedQuery, ProtectedQueryVariables>(ProtectedDocument, options);
        }
